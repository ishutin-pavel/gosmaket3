    ...
    <div class="page__cell">
        <div class="page__block">
            <?php while ( have_posts() ) : the_post(); ?>
              <?php the_content(); ?>
            <? endwhile;?>
            <h2 style="margin-bottom:60px" class="works__title">LAYOUT STUDIO - A PLACE WHERE THE PROFESSIONALS OF VARIOUS PROFILE COMBINE TO SOLVE THE SPECIFIC DELIVERED MARKETING PROBLEM</h2>

            <div class="article">
                <div class="row">			
                    <div class="col-12 col-lg-6">
                        <div class="article__block">
                            <h3 class="title title--mr">FOR A BIG UNDERSTANDING, DISCUSSING EXAMPLES</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="article__block">
                            <h3 class="title title--mr">NEXT EXAMPLE</h3>
            ...
            <h3 class="works__title">THE LAYOUT OF YOUR CONSTRUCTION IS THE FACE OF YOUR COMPANY FOR THE WHOLE MARKETING ACTION. SO LETTER IN THIS CASE YOU REPRESENT A QUALITATIVE BEAUTIFUL LAYOUT FILLED WITH LIGHTING AND DYNAMIC OBJECTS, MAKE THAT YOUR OBJECT BECOMES EXTREME.</h3>
    </div>
</div>
</div>
<?php get_footer(); ?>
